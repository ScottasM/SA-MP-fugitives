...
{
	// �ia baigus path� yra parenkamas naujas ir u�dedamas jam va�iuot.
...
{
    if(IsPlayerInAnyVehicle(playerid))return Error(playerid, "Transporto priemon�je surakinti negalima.");
